...
use App\Good\Command\CreateGoodCommand;
...
class CreateGoodCliCommand extends Command
{
    ...
    public function __construct(CommandBusInterface $commandBus)
    {
        ...
        parent::__construct('good:create');

        $this->addArgument('goodCode', InputArgument::REQUIRED);
        $this->addArgument('goodName', InputArgument::REQUIRED);
